...
setInterval(() => {
  ...
  sec += 1 
  ReactDOM.createRoot(document.getElementById('app')).render(<SecondsCounter digitOne={One} digitTwo={Two} digitThree={Three} digitFour={Four} digitFive={Five} digitSix={Six} />);
